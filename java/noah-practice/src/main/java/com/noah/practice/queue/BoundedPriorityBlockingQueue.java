...
public class BoundedPriorityBlockingQueue<E> extends AbstractQueue<E>
    ...
    public BoundedPriorityBlockingQueue(Collection<? extends E> c) {
        ...
        if (c instanceof SortedSet<?>) {
            ...
            heapify = false;
        } else if (c instanceof BoundedPriorityBlockingQueue<?>) {
            BoundedPriorityBlockingQueue<? extends E> pq =
                    (BoundedPriorityBlockingQueue<? extends E>) c;
            this.comparator = (Comparator<? super E>) pq.comparator();
            screen = false;
            if (pq.getClass() == BoundedPriorityBlockingQueue.class) // exact match
                heapify = false;
        }
        Object[] a = c.toArray();
        int n = a.length;
    ...
    static final class PBQSpliterator<E> implements Spliterator<E> {
        final BoundedPriorityBlockingQueue<E> queue;
        Object[] array;
        int index;
        int fence;

        PBQSpliterator(BoundedPriorityBlockingQueue<E> queue, Object[] array,
                       int index, int fence) {
            this.queue = queue;
            this.array = array;
            this.index = index;
    ...
    static {
        try {
            ...
            Class<?> k = BoundedPriorityBlockingQueue.class;
